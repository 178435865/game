#ifndef _EQUIPMENT_MEDIATOR_
#define _EQUIPMENT_MEDIATOR_
...
class EquipmentMediator :public Mediator,public GameScene
{
public:
	bool init();
	...
	CREATE_SCENE_FUNC(EquipmentMediator);
	void initInterests();
private:
	EquipmentMediator();
	virtual ~EquipmentMediator();
	void initButton();
private:
	UIWidget* ui;
	UIWidget* commToolbarUi;
