...
void LoginMediator::callback(CCObject *obj, TouchEventType type)
{
...
{
	UtilCocostudio::getInstance()->addEventRelease(this,toucheventselector(LoginMediator::callback),"close_Button",ui);
	UtilCocostudio::getInstance()->addEventRelease(this,toucheventselector(LoginMediator::callback),"login_Button",ui);
...
{
	ui=UtilCocostudio::getInstance()->createWidgetFromJsonFile("DemoLogin.json");
